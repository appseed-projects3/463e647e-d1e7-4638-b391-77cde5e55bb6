...
- ✅ [PRO Version Available](https://appseed.us/product/material-kit2-pro/django/) - `enhanced UI` and more `features`  
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/463e647e-d1e7-4638-b391-77cde5e55bb6.git
$ cd 463e647e-d1e7-4638-b391-77cde5e55bb6
```
